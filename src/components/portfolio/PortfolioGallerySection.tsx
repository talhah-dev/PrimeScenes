...
const items: PortfolioItem[] = [
    {
        ...
        category: 'Explainers',
        thumbnail: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
        ...
        category: 'Ads',
        thumbnail: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
        ...
        category: 'Onboarding',
        thumbnail: 'https://images.unsplash.com/photo-1553877522-43269d4ea984?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
        ...
        category: 'Training',
        thumbnail: 'https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
        ...
        thumbnail: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
        ...
        category: 'Social',
        thumbnail: 'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                            ...
                            {categories.map((c) => (
                                <Button
                                    ...
                                    className={cx(
                                        ...
                                        active === c ? 'bg-[#0A211F] text-[#8AF7B7] hover:bg-[#0A211F]/90' : 'border-black/10 bg-white text-[#0A211F] hover:bg-black/5'
                                    )}
                                >
                                    {c}
                                </Button>
                    ...
                    <div className="mt-8 grid gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                        {filtered.map((it) => (
                            <div className="flex w-full flex-col text-start" key={it.title}>
                                <Card className="mb-3 overflow-hidden py-0 rounded-xl border border-black/10 bg-white shadow-[0_20px_70px_-55px_rgba(0,0,0,.35)]">
                                ...
                                <p className="mt-2 max-w-[32ch] text-[15px] leading-relaxed line-clamp-2 text-[#0A211F]/70">
                                    {it.description}
                                </p>

                                <div className="mt-3">
                                    <Link href={it.href} className='flex items-center gap-2 hover:gap-3 transition-all duration-500 text-sm font-medium'>
